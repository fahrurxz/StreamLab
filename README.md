...
# StreamLab v2.0: Fresh From The Oven🔥

StreamLab adalah aplikasi live streaming yang memungkinkan kamu untuk melakukan live streaming ke berbagai platform seperti YouTube, Facebook, dan platform lainnya menggunakan protokol RTMP. Aplikasi ini bisa berjalan di VPS (Virtual Private Server) dan mendukung streaming ke banyak platform sekaligus.
...
### 2. Setup Projek StreamLab

Clone repository ke VPS:

```bash
git clone https://github.com/bangtutorial/StreamLab
```
...
### 5. Cara Jalankan Aplikasi StreamLab

Pastikan kamu masih berada di folder **StreamLab**, jalankan perintah ini:

```bash
pm2 start app.js --name StreamLab
```
...
[![MIT License](https://img.shields.io/badge/License-MIT-green.svg)](https://github.com/bangtutorial/StreamLab/blob/main/LICENSE)
